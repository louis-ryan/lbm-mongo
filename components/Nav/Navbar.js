    ...
    return (
        <div style={{ width: "100vw", position: "fixed", bottom: "0px", left: "0px", backgroundColor: "white", zIndex: "400", display: "flex", justifyContent: "space-around", alignItems: "center", boxShadow: "0px 0px 40px 8px black", padding: "8px" }}>
            ...
            <div style={{ width: "calc(100% / 3)" }}>
                ...
                >
                    <svg width="40px" height="40px" viewBox="0 0 2365 2365">
                        <g id="LBM_button_home" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                            <circle id="Oval" stroke="#1F1F1F" strokeWidth="80" cx="1182.5" cy="1182.5" r="1142.5"></circle>
            ...
            <div style={{ width: "calc(100% / 3)" }}>
                ...
                >
                    <svg width="40px" height="40px" viewBox="0 0 2365 2365">
                        <g id="LBM_button_new" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
            ...
            <div style={{ width: "calc(100% / 3)" }}>
                ...
                >
                    {user !== undefined ? (
                        <svg width="40px" height="40px" viewBox="0 0 2365 2365">
                            <g id="LBM_button_signout" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                                <circle id="Oval" stroke="#1F1F1F" strokeWidth="80" cx="1182.5" cy="1182.5" r="1142.5"></circle>
                                <g id="Group" transform="translate(542.000000, 700.000000)" stroke="#C3C3C3" strokeLinecap="round" strokeWidth="111">
                                ...
                                <g id="Group" transform="translate(502.000000, 730.000000)" stroke="#D97777" strokeLinecap="round" strokeWidth="111">
                                    <polyline id="Line" points="885 0 0 0 0 905 885 905"></polyline>
                                    <line x1="442.5" y1="452.5" x2="1346.5" y2="453.5" id="Line-2"></line>
                                    <polyline id="Line-4" points="1164 181 1399 442.998326 1164 700"></polyline>
                                </g>
                        ...
                        <svg width="40px" height="40px" viewBox="0 0 2365 2365">
                            <g id="LBM_button_signin" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                                <circle id="Oval" stroke="#1F1F1F" strokeWidth="80" cx="1182.5" cy="1182.5" r="1142.5"></circle>
                                <g id="Group" transform="translate(1123.000000, 1167.500000) scale(-1, 1) translate(-1123.000000, -1167.500000) translate(520.000000, 715.000000)" stroke="#C3C3C3" strokeLinecap="round" strokeWidth="111">
                                ...
                                <g id="Group" transform="translate(1095.500000, 1197.500000) scale(-1, 1) translate(-1095.500000, -1197.500000) translate(480.000000, 745.000000)" stroke="#77A9D9" strokeLinecap="round" strokeWidth="111">
