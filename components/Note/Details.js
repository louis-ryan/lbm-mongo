            ...
            svg: (
                <svg width="40px" height="40px" viewBox="0 0 40 40">
                    <g id="Garden" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <path d="M22,33 C22.6666667,31.6666667 27.3333333,32.3333333 36,35" id="Line-13-Copy" stroke="#979797" fill="#FFFFFF" stroke-linecap="square"></path>
                        ...
                        <path d="M4,35 C6,33.6666667 9.66666667,33 15,33 C20.3333333,33 24.3333333,33.6666667 27,35" id="Line-13" stroke="#979797" fill="#FFFFFF" stroke-linecap="square"></path>
                    </g>
                </svg>
            )
            ...
            svg: (
                <svg width="40px" height="40px" viewBox="0 0 40 40">
                    <g id="Outdoor" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <line x1="13" y1="19.09375" x2="13" y2="36.90625" id="Line-2-Copy" stroke="#979797" stroke-linecap="square"></line>
                        <line x1="27" y1="19.09375" x2="27" y2="36.90625" id="Line-2-Copy-2" stroke="#979797" stroke-linecap="square"></line>
                        <line x1="20" y1="19.09375" x2="20" y2="36.90625" id="Line-2" stroke="#979797" stroke-linecap="square"></line>
            ...
            svg: (
                <svg width="40px" height="40px" viewBox="0 0 40 40">
                    <g id="Parking" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <line x1="17.5" y1="10.4347826" x2="17.5" y2="29.5652174" id="Line-5" stroke="#979797" stroke-linecap="round"></line>
                        <path d="M17.5,10.0255102 C23.1666667,10.0085034 26,11.6666667 26,15 C26,18.3333333 23.1666667,19.9914966 17.5,19.9744898" id="Line" stroke="#979797" stroke-linecap="square"></path>
                    </g>
                </svg>
            )
        },
            ...
            <div style={{ ...itemStyle, display: "flex", overflow: "hidden" }}>
                ...
                <div style={{
                    ...
                    <div style={{ position: "absolute", width: "1600px", height: "1600px", zIndex: "20", marginTop: "-1600px" }}>
                        <div style={{ width: "120px", height: "120px", backgroundColor: "white", marginLeft: `${longInPx - 120}px`, marginTop: `${latInPx - 120}px`, borderRadius: "50%", border: "1px solid grey" }}></div>
                    </div>
            ...
            <div style={{ ...itemStyle }}>
                ...
                <div style={{ display: "flex", flexWrap: "wrap" }}>
                    {featuresArr.map((feature) => {
                        ...
                        return (
                            <div style={{ width: deviceSize === "DESKTOP" ? "calc(100% / 4)" : "calc(100% / 2)", padding: "24px" }}>
